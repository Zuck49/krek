...
def cekAPI(cookie):
	...
	try:
		...
		c=request.get.autofollowers("https://topfollow.app/%s/?__a=1"%(user), Login'clear=clear': clear}, login={"user-name":USN}}
...
{H}[*] ---------------------------------------------
{H}[*] Kadaluwarsa : Terserah Paduka Niki
